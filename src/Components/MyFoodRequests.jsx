    ...
    <div className="container mx-auto p-4 sm:p-6 pt-24">
      ...
      </h1>
      {
        requests.length === 0 ? (
          ...
          <table className="min-w-full sm:w-[272px] border-collapse border border-gray-500">
            <thead>
              <tr className="bg-gray-900">
                <th className="px-2 sm:px-4 py-2 text-left text-sm sm:text-base font-semibold text-gray-500 w-1/6">
                  Food Name
                </th>
                <th className="px-2 sm:px-4 py-2 text-left text-sm sm:text-base font-semibold text-gray-500 w-1/6">
                  Pickup Location
