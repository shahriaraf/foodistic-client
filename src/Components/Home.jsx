    ...
    <div className="bg-gray-50">
      ...
      <div className="bg-gray-50 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <div className="text-center p-6 bg-amber-50 shadow-lg rounded-lg">
            <img
          ...
          <div className="text-center p-6 bg-amber-50 shadow-lg rounded-lg">
            <img
              ...
              alt="Step 3"
              className="w-full h-max mx-auto mb-4"
            />
            <h3 className="text-xl font-semibold text-gray-800 mb-2">Pickup</h3>
            <p className="text-gray-600">
