...
const Register = () => {
  ...
  return (
    <div className="min-h-screen pt-32 pb-6 flex items-center justify-center bg-gradient-to-br from-amber-600 via-amber-300 to-amber-600 text-white">
      <div className="w-full max-w-md p-8 bg-amber-950 backdrop-blur-md rounded-lg shadow-lg">
        ...
        <form onSubmit={handleRegister} className="mt-6 space-y-4">
          ...
          <button type="submit" className="w-full bg-amber-400 hover:bg-amber-600 transition-colors py-3 rounded-lg font-semibold text-amber-950 shadow-md">Sign Up</button>
        </form>

        <div className="mt-4 text-center">
          <p className="text-gray-400">Already have an account? <Link className="text-amber-400 hover:underline" to="/login">Log in</Link></p>
        </div>
